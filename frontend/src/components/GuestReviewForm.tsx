...
import { guestReviewService } from '@/services'
import type { CreateGuestReviewData } from '@/types'
...
export default function GuestReviewForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const data: CreateGuestReviewData = {
        bookingId,
        guestId,
        rating,
      ...
      await guestReviewService.createReview(data)
      setSuccess(true)
      setComment('')
      setRating(5)
    ...
    return (
      <div className="bg-green-50 border border-green-200 rounded-xl p-6 text-center">
        ...
        <p className="text-green-700">
          Thank you for reviewing {guestName}.
        </p>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-4">
      <p className="text-gray-600">
        Share your experience hosting <span className="font-semibold">{guestName}</span>
      </p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="How was your experience hosting this guest? Were they respectful, communicative, and did they follow house rules?"
            required
            minLength={10}
          />
